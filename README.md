...
```shell
docker run -d --restart=always -p 27017:27017 --name mongo -v /opt/mongo/data/db:/data/db mongo:4.4 --auth
```
...
# 这里创建了一个名为mongo，密码为`mongo`，具有root角色（最高权限角色）的用户。
...
![客户端连接](https://cdn.jsdelivr.net/gh/lingzhexi/blogImage/post/%E6%88%AA%E5%9B%BE_%E9%80%89%E6%8B%A9%E5%8C%BA%E5%9F%9F_20241010155218.png)
...
```java
package com.stormling.mongo_demo.model;
...
```java
package com.stormling.mongo_demo.repository;

import com.stormling.mongo_demo.model.User;
import org.bson.types.ObjectId;
...
```java
package com.stormling.mongo_demo;

import com.stormling.mongo_demo.model.User;
import com.stormling.mongo_demo.repository.UserRepository;
import org.bson.types.ObjectId;
